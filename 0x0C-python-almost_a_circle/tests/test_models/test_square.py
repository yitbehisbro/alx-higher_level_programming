#!/usr/bin/python3
""" Test case for subclass of Rectangle module file"""
import unittest
...
class TestSquareSubClassMethods(unittest.TestCase):
    """ Test case for Square subclass """
    ...
    def test_incorrect_amount_1(self):
