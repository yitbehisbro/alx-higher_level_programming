<h1 class="gap">0x05. Python - Exceptions</h1>
    <!-- Task Body -->
    <p>0. Write a function that prints <code>x</code> elements of a list.</p>
...
guillaume@ubuntu:~/0x05$ 
    ...
    <!-- Task Body -->
    <p>2. Write a function that prints the first <code>x</code> elements of a list and only integers.</p>
...
guillaume@ubuntu:~/0x05$ 
    ...
    <!-- Task Body -->
    <p>4. Write a function that divides element by element 2 lists.</p>
...
guillaume@ubuntu:~/0x05$ 
    ...
    <!-- Task Body -->
    <p>5. Write a function that raises a type exception.</p>
