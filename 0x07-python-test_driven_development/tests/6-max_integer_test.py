...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_max(self):
        ...
        self.assertAlmostEqual(max_integer([-321, 1000002742, 7141143787, 14]), 7141143787)
        self.assertAlmostEqual(max_integer([1000, 1000, 1000, 1000]), 1000)
        self.assertAlmostEqual(max_integer([452, 522, 654, 785, 654, 231, 456,
                                           201, 654, 352, 635, 451, 6321, 231,
                                           154, 251, 632, 152, 7141143787]), 7141143787)
    def test_float(self):
    ...
    def test_raise(self):
        ...
        self.assertRaises(KeyError, max_integer, max_integer({'id1': 100, 'id2': 200}))
